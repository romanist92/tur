...
public class tur {
          public static void main (String [] args) throws java.io.IOException{
            ...
            Scanner sc4 = new Scanner (System.in);          /* считывает данные для расчета длительности тура поездки*/
            int dlitelnost = sc4.nextInt();                /* запоминает данные для расчета длительности тура поездки*/    
